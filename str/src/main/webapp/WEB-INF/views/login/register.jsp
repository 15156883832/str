	...
	<div class="cont-main clearfix">
		<div class="index-tab">
			<div class="index-slide-nav">
				...
				<a href="${path}/user/registerPage" class="active">注册</a>
		...
		<div class="login form">
			<div class="group">
				<div class="group-ipt email">
					<input type="email" name="email" id="email" maxlength="50" style="width:270px;" class="ipt" onkeydown="enterEvent2(event)" placeholder="邮箱地址" required>
					<i class="" title=""></i>
				</div>
				<div class="group-ipt user">
					<input type="text" name="ncName" id="ncName" class="ipt" maxlength="50" style="width:270px;" onkeydown="enterEvent2(event)"  placeholder="请填写一个昵称" required>
					<i class=""></i>
				</div>
				<div class="group-ipt password">
					<input type="password" name="password" id="password" style="width:258px;" class="ipt"   maxlength="20" onkeydown="enterEvent2(event)" placeholder="设置登录密码" required>
					<i class="myicon-eye-open" title="神说，要有光" style="margin-left:15px;cursor:hand;" onclick="seePassword();"></i>
				</div>
				<div class="group-ipt password1">
					<input type="password" name="password1" style="width:258px;" id="password1" class="ipt"  maxlength="20" onkeydown="enterEvent2(event)" placeholder="重复密码" required>
					<i style="margin-left:15px;cursor:hand;" onclick="seePassword2();" title="神说，要有挂" class="myicon-eye-open"></i>
				</div>
				<div class="group-ipt verify">
					<input type="text" name="verify" id="verify" class="ipt"  maxlength="4" onkeydown="enterEvent2(event)"  placeholder="输入邮箱验证码" required>
